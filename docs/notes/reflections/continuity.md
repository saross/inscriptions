...
started: 2026-04-24
last-updated: 2026-06-03 (Grid A adjudicated FAIL → metric-correction: Decision 33 + OSF Amendment 01 §A5.5.1 (α demoted to diagnostic, operating-envelope reframe), scout+review-confirmed; utility review + 2 diagnostics (band overconfident for peaked-at-large-N; real-corpus α>0.70 across AD 142–347); Decision 34 (subset-specific deconvolution); small-N reachability study launched but BLOCKED — zbook overloaded off network at 99.5%, floor pending. Grid B 441/450 finishing)
---
