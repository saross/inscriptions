...
started: 2026-04-24
last-updated: 2026-06-02 (§5 posteriors backed up to rpi-qnap, sha-verified; dependency hygiene merged — pymc-6 stack standardised, uv.lock refreshed, preflight + --resume-diagnostics added (PR #5, /audit-clean, e2e bit-for-bit); Grid B running on sapphire ~81%, ETA 3 June)
---
