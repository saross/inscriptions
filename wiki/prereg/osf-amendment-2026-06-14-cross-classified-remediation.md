...
amendment-number: "04"
status: "LODGED 2026-06-14 (OSF; Amendment 04; git tag osf-amendment-04-2026-06-14 → 61c954c). [Header corrected 2026-06-18: previously read 'DRAFT … NOT lodged', which was stale — lodgement confirmed by the tag, the summary-addendum, and the 2026-06-14 continuity close.] Reverses the lodged Amendment 03 shared basis (Amendment 03 itself lodged 2026-06-08, tag osf-amendment-03-2026-06-08 → 90897d6). The θ robustness work is folded into §A5.7 (production θ prior re-centred to the re-derived θ_gen 0.025 and the refit re-run, §A5.1/§A5.4(b))."
