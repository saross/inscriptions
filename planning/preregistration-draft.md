...
status: draft 2026-04-27 (round-2 forward-fit pivot per Decisions 8–10 applied 2026-04-26; round-2 follow-ups 2026-04-27: §4 Crisis-of-Third-Century exploratory H3b cell + §5 H3a variance-partition exploratory + §5 small-N trajectory estimation Layers A + B + aggregate diagnostic + province-scale parallel methodological output + §6 Crisis row + FS-4 provincial-prosperity follow-up; round-1 5 amendments retained); awaiting Adela review
