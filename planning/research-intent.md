...
A complementary framing applies at the urban scale: inscriptions function as **information infrastructure** (Hanson 2021) and scale **sublinearly** with urban population (β ≈ 0.64 in Hanson 2021; β ≈ 0.3–0.5 in Carleton et al. 2025; β ∈ [0.47, 0.68] across OLS log-log and Negative Binomial regressions in Ross 2024 archived preliminary analysis — four-way convergence across datasets, regression families, and research groups). A sublinear β means per-capita inscription rates *decrease* with city size — behaviour consistent with communication-infrastructure saturation (compare roads and piped water, also sublinear in Hanson-Ortman-Bettencourt-Mazur 2019) rather than super-linear socio-economic output (compare coinage, pottery, housing: β > 1 per Ortman-Lobo et al. 2024 in Roman Britain). The multi-factor decomposition identifies *what drives* inscription production; the information-infrastructure framing explains *how production scales with settlement size*. Both inform the paper's claims.
