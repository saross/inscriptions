...
1. **Interval-width diagnostic**
   ...
   (the width-100 *class* is 26.29 % of the corpus = 47,487 rows; the exact
   `[1, 100]` template alone is ~6.0 % = 10,807 rows — see
   `runs/2026-05-17-interval-width-diagnostic/outputs/REPORT.md:41`. [Clarified
   2026-06-20, accuracy audit: the original "[1, 100] is 26 %" conflated the whole
   width-100 class with the single `[1, 100]` template.] [101, 200] and [201, 300]
   add roughly the same magnitude again), and that the headline 22.8 ×
...
- **§2 Description rewritten** to drop the misleading "midpoint
  ...
  in-00; the width-100 *class* is 26.29 % of corpus, the exact `[1, 100]`
  template ~6.0 % [clarified 2026-06-20, accuracy audit — was "[1, 100] is
  26 % of corpus"; see the L485 note and REPORT.md:41]) plus real ancient regnal
