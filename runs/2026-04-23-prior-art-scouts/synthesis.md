...
- Hanson 2021 (*Journal of Urban Archaeology* 4:137–52; **verified from local PDF 2026-04-24**, Zotero keys GHPTNHBI / 9Z7EFZVA): **β = 0.672 mean (95 % CI [0.588, 0.756]) / β = 0.654 median [0.514, 0.774]** for direct inscription-count-vs-population regression; OLS log-log on 8 equally-sized population bins (Stock & Watson 2019 method); n = 554 sites with ≥ 1 inscription out of 593; EDCS corpus (not LIRE); **Rome excluded as extreme outlier**. Explicitly frames inscriptions as "infrastructure for information" (pp. 139–140, 147): "any infrastructure for conveying information would increase more slowly than population, with an exponent of about two-thirds." No chronological periodisation (pooled). Residuals: **provincial capitals over-produce** (mean residual 0.43 vs ~0.06 for *coloniae* / *municipia*); **spatially clustered** (Moran's I = 0.046, z = 4.571, p < 0.0001).
- Hanson, Ortman & Lobo 2017 (*J. R. Soc. Interface*): **β = 0.686** (SE 0.078, R² = 0.267) for **functional diversity** vs population — inscriptions used as the *sampling frame* for counting associations, not as the output variable directly. Sublinear, but measures a different relationship than Hanson 2021. **Correction**: the "β ≈ 0.643" attributed to HOL 2017 in Scout 2 via Brewminate reconstruction was misattributed — HOL 2017 does not run a direct inscription-count vs population regression.
