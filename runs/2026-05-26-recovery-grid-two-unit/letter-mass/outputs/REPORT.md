...
> **Convergence-excluded cells.** 360 in-envelope cell(s) fall below the convergence precondition (< 90% of replicates pass R̂ / bulk-ESS) and so are excluded from the headline (B 0.0%) but not from the diagnostic (A nan%); by shape: {'bimodal': 60, 'flat_baseline': 60, 'regnal_cluster': 60, 'rise_and_fall': 60, 'smooth_decline': 60, 'smooth_growth': 60}. Under the field-standard gate (R̂ / bulk-ESS only; divergences are recorded but not auto-failing — `cell_lib.convergence_pass`, Decision 33 / §A5.5.1) these are genuine sampling-convergence failures, not the benign flat-null divergences the earlier zero-tolerance gate tripped on.
...
| `shape=rise_and_fall_alpha=0.95_tier=century_heavy_N=10000` | 0.00 | 0.0582 | 51.60 | 0.63 | 1 |
...
| `shape=smooth_growth_alpha=0.95_tier=century_heavy_N=10000` | 0.00 | 0.1597 | 55.60 | 0.51 | 2 |
...
| `shape=regnal_cluster_alpha=0.95_tier=century_heavy_N=10000` | 0.00 | 0.2098 | 38.52 | 0.59 | 1 |
...
| `shape=rise_and_fall_alpha=0.95_tier=reign_heavy_N=10000` | 0.00 | 0.3229 | 40.61 | 0.51 | 1 |
...
| `shape=smooth_growth_alpha=0.70_tier=century_heavy_N=10000` | 0.00 | 0.5626 | 35.51 | 0.54 | 7 |
| `shape=smooth_decline_alpha=0.70_tier=pilot_proxy_N=10000` | 0.00 | 0.5632 | 29.74 | 0.53 | 0 |
| `shape=bimodal_alpha=0.70_tier=uniform_N=10000` | 0.00 | 0.5759 | 12.04 | 0.49 | 5 |
...
| `shape=rise_and_fall_alpha=0.70_tier=pilot_proxy_N=10000` | 0.00 | 0.6848 | 32.72 | 0.60 | 1 |
...
| `shape=rise_and_fall_alpha=0.70_tier=century_heavy_N=10000` | 0.00 | 0.6921 | 36.22 | 0.46 | 5 |
| `shape=bimodal_alpha=0.70_tier=century_heavy_N=50000` | 0.00 | 0.7064 | 12.20 | 0.24 | 40 |
...
| `shape=bimodal_alpha=0.70_tier=pilot_proxy_N=50000` | 0.00 | 0.7312 | 12.22 | 0.09 | 238 |
...
| `shape=rise_and_fall_alpha=0.70_tier=reign_heavy_N=10000` | 0.00 | 0.7445 | 23.51 | 0.53 | 12 |
...
| `shape=bimodal_alpha=0.70_tier=uniform_N=50000` | 0.00 | 0.7729 | 10.04 | 0.22 | 6 |
...
| `shape=rise_and_fall_alpha=0.30_tier=uniform_N=2000` | 0.00 | 0.8217 | 11.99 | 0.46 | 1 |
...
| `shape=rise_and_fall_alpha=0.70_tier=century_heavy_N=50000` | 0.00 | 0.8633 | 29.85 | 0.38 | 37 |
...
| `shape=rise_and_fall_alpha=0.50_tier=reign_heavy_N=10000` | 0.00 | 0.8794 | 14.85 | 0.60 | 2 |
| `shape=bimodal_alpha=0.50_tier=century_heavy_N=50000` | 0.00 | 0.8814 | 9.62 | 0.13 | 226 |
| `shape=rise_and_fall_alpha=0.70_tier=reign_heavy_N=50000` | 0.00 | 0.8861 | 20.34 | 0.12 | 867 |
| `shape=bimodal_alpha=0.50_tier=reign_heavy_N=50000` | 0.00 | 0.8862 | 6.32 | 0.06 | 54 |
...
| `shape=bimodal_alpha=0.50_tier=pilot_proxy_N=50000` | 0.00 | 0.8936 | 8.63 | 0.14 | 44 |
...
| `shape=bimodal_alpha=0.50_tier=uniform_N=50000` | 0.00 | 0.9053 | 6.94 | 0.13 | 8 |
...
| `shape=rise_and_fall_alpha=0.30_tier=century_heavy_N=10000` | 0.00 | 0.9304 | 15.27 | 0.19 | 52 |
...
| `shape=rise_and_fall_alpha=0.50_tier=pilot_proxy_N=50000` | 0.00 | 0.9451 | 20.73 | 0.15 | 13 |
| `shape=rise_and_fall_alpha=0.50_tier=reign_heavy_N=50000` | 0.00 | 0.9508 | 12.38 | 0.16 | 559 |
| `shape=rise_and_fall_alpha=0.50_tier=century_heavy_N=50000` | 0.00 | 0.9525 | 23.36 | 0.15 | 621 |
...
| `shape=rise_and_fall_alpha=0.30_tier=uniform_N=50000` | 0.00 | 0.9773 | 9.17 | 0.32 | 1 |
...
| `shape=smooth_growth_alpha=0.70_tier=half_century_heavy_N=50000` | 0.01 | 0.7089 | 23.31 | 0.31 | 1 |
| `shape=smooth_growth_alpha=0.70_tier=pilot_proxy_N=50000` | 0.01 | 0.7110 | 26.89 | 0.13 | 28 |
| `shape=smooth_decline_alpha=0.70_tier=century_heavy_N=50000` | 0.01 | 0.7282 | 27.38 | 0.34 | 2 |
| `shape=smooth_decline_alpha=0.50_tier=century_heavy_N=10000` | 0.01 | 0.7323 | 25.56 | 0.54 | 9 |
| `shape=smooth_decline_alpha=0.70_tier=pilot_proxy_N=50000` | 0.01 | 0.7430 | 22.11 | 0.11 | 55 |
| `shape=smooth_growth_alpha=0.70_tier=century_heavy_N=50000` | 0.01 | 0.7459 | 25.60 | 0.32 | 2 |
| `shape=smooth_decline_alpha=0.70_tier=reign_heavy_N=50000` | 0.01 | 0.7554 | 19.34 | 0.16 | 48 |
...
| `shape=rise_and_fall_alpha=0.30_tier=century_heavy_N=50000` | 0.01 | 0.9724 | 15.24 | 0.03 | 1144 |
...
| `shape=smooth_decline_alpha=0.70_tier=uniform_N=50000` | 0.02 | 0.7145 | 26.08 | 0.28 | 1 |
| `shape=smooth_growth_alpha=0.70_tier=uniform_N=50000` | 0.02 | 0.7157 | 27.29 | 0.22 | 0 |
| `shape=smooth_decline_alpha=0.50_tier=reign_heavy_N=10000` | 0.02 | 0.7374 | 13.45 | 0.67 | 1 |
...
| `shape=smooth_growth_alpha=0.50_tier=half_century_heavy_N=10000` | 0.04 | 0.6743 | 16.27 | 0.47 | 9 |
| `shape=bimodal_alpha=0.30_tier=uniform_N=50000` | 0.04 | 0.9521 | 4.41 | 0.06 | 14 |
| `shape=regnal_cluster_alpha=0.30_tier=uniform_N=10000` | 0.04 | 0.9674 | 6.17 | 0.22 | 0 |
| `shape=rise_and_fall_alpha=0.30_tier=reign_heavy_N=50000` | 0.04 | 0.9756 | 6.54 | 0.16 | 105 |
...
| `shape=smooth_decline_alpha=0.50_tier=century_heavy_N=50000` | 0.16 | 0.8759 | 19.54 | 0.16 | 206 |
...
| `shape=smooth_decline_alpha=0.30_tier=century_heavy_N=10000` | 0.23 | 0.8553 | 12.56 | 0.35 | 106 |
...
| `shape=smooth_decline_alpha=0.30_tier=half_century_heavy_N=10000` | 0.31 | 0.8088 | 13.14 | 0.37 | 75 |
...
| `shape=smooth_growth_alpha=0.30_tier=century_heavy_N=10000` | 0.37 | 0.8332 | 12.25 | 0.42 | 1515 |
...
| `shape=smooth_decline_alpha=0.30_tier=century_heavy_N=50000` | 0.40 | 0.9370 | 13.59 | 0.12 | 432 |
| `shape=flat_baseline_alpha=0.05_tier=half_century_heavy_N=10000` | 0.41 | nan | 7.60 | 0.51 | 20 |
| `shape=smooth_decline_alpha=0.50_tier=reign_heavy_N=50000` | 0.43 | 0.8891 | 8.82 | 0.19 | 65 |
| `shape=smooth_growth_alpha=0.30_tier=pilot_proxy_N=10000` | 0.45 | 0.8243 | 13.75 | 0.46 | 11 |
| `shape=rise_and_fall_alpha=0.05_tier=century_heavy_N=10000` | 0.45 | 0.9604 | 3.26 | 0.07 | 353 |
| `shape=flat_baseline_alpha=0.05_tier=uniform_N=10000` | 0.46 | nan | 6.92 | 0.39 | 29 |
| `shape=smooth_growth_alpha=0.30_tier=half_century_heavy_N=10000` | 0.47 | 0.8202 | 10.19 | 0.34 | 55 |
| `shape=flat_baseline_alpha=0.30_tier=century_heavy_N=2000` | 0.47 | nan | 6.94 | 0.58 | 0 |
| `shape=smooth_growth_alpha=0.30_tier=uniform_N=10000` | 0.48 | 0.8295 | 13.04 | 0.34 | 43 |
| `shape=smooth_decline_alpha=0.30_tier=pilot_proxy_N=50000` | 0.48 | 0.9351 | 8.52 | 0.26 | 26 |
...
| `shape=flat_baseline_alpha=0.05_tier=reign_heavy_N=10000` | 0.51 | nan | 6.41 | 0.60 | 54 |
...
| `shape=flat_baseline_alpha=0.05_tier=half_century_heavy_N=50000` | 0.52 | nan | 3.60 | 0.18 | 1448 |
| `shape=flat_baseline_alpha=0.05_tier=pilot_proxy_N=10000` | 0.53 | nan | 6.09 | 0.39 | 126 |
| `shape=flat_baseline_alpha=0.05_tier=century_heavy_N=50000` | 0.54 | nan | 4.27 | 0.18 | 1150 |
| `shape=flat_baseline_alpha=0.05_tier=reign_heavy_N=50000` | 0.54 | nan | 3.69 | 0.13 | 921 |
| `shape=bimodal_alpha=0.05_tier=pilot_proxy_N=10000` | 0.55 | 0.9302 | 3.16 | 0.08 | 0 |
| `shape=flat_baseline_alpha=0.05_tier=pilot_proxy_N=50000` | 0.55 | nan | 4.10 | 0.21 | 918 |
| `shape=rise_and_fall_alpha=0.05_tier=pilot_proxy_N=10000` | 0.56 | 0.9574 | 3.05 | 0.09 | 320 |
...
| `shape=smooth_growth_alpha=0.30_tier=uniform_N=50000` | 0.59 | 0.9350 | 10.19 | 0.20 | 81 |
| `shape=flat_baseline_alpha=0.05_tier=uniform_N=50000` | 0.59 | nan | 4.07 | 0.17 | 1649 |
| `shape=bimodal_alpha=0.05_tier=reign_heavy_N=10000` | 0.61 | 0.9194 | 3.48 | 0.05 | 0 |
| `shape=flat_baseline_alpha=0.05_tier=century_heavy_N=10000` | 0.61 | nan | 5.37 | 0.54 | 51 |
| `shape=flat_baseline_alpha=0.30_tier=half_century_heavy_N=50000` | 0.61 | nan | 5.63 | 0.20 | 63 |
| `shape=flat_baseline_alpha=0.30_tier=pilot_proxy_N=50000` | 0.61 | nan | 5.94 | 0.32 | 87 |
| `shape=flat_baseline_alpha=0.30_tier=century_heavy_N=50000` | 0.62 | nan | 5.91 | 0.27 | 266 |
| `shape=flat_baseline_alpha=0.30_tier=uniform_N=50000` | 0.62 | nan | 5.61 | 0.30 | 17 |
...
| `shape=flat_baseline_alpha=0.50_tier=uniform_N=50000` | 0.65 | nan | 7.66 | 0.40 | 8 |
| `shape=bimodal_alpha=0.05_tier=century_heavy_N=10000` | 0.67 | 0.9241 | 3.68 | 0.10 | 0 |
| `shape=smooth_growth_alpha=0.30_tier=half_century_heavy_N=50000` | 0.67 | 0.9267 | 6.85 | 0.13 | 178 |
| `shape=rise_and_fall_alpha=0.05_tier=pilot_proxy_N=50000` | 0.67 | 0.9881 | 2.30 | 0.05 | 401 |
| `shape=flat_baseline_alpha=0.30_tier=pilot_proxy_N=10000` | 0.67 | nan | 9.46 | 0.45 | 21 |
| `shape=flat_baseline_alpha=0.50_tier=pilot_proxy_N=50000` | 0.68 | nan | 6.51 | 0.18 | 3 |
| `shape=smooth_growth_alpha=0.30_tier=pilot_proxy_N=50000` | 0.69 | 0.9279 | 10.22 | 0.14 | 12 |
| `shape=rise_and_fall_alpha=0.05_tier=uniform_N=10000` | 0.69 | 0.9659 | 2.59 | 0.11 | 2890 |
| `shape=flat_baseline_alpha=0.30_tier=century_heavy_N=10000` | 0.70 | nan | 7.25 | 0.55 | 22 |
| `shape=flat_baseline_alpha=0.30_tier=reign_heavy_N=10000` | 0.72 | nan | 7.50 | 0.53 | 6 |
| `shape=flat_baseline_alpha=0.30_tier=half_century_heavy_N=10000` | 0.73 | nan | 8.20 | 0.57 | 2 |
...
| `shape=rise_and_fall_alpha=0.05_tier=reign_heavy_N=10000` | 0.75 | 0.9616 | 2.76 | 0.11 | 546 |
...
| `shape=flat_baseline_alpha=0.30_tier=uniform_N=10000` | 0.77 | nan | 7.57 | 0.60 | 3 |
...
| `shape=smooth_growth_alpha=0.05_tier=uniform_N=10000` | 0.86 | 0.8965 | 4.17 | 0.23 | 86 |
| `shape=regnal_cluster_alpha=0.05_tier=reign_heavy_N=10000` | 0.86 | 0.9823 | 3.25 | 0.14 | 0 |
| `shape=rise_and_fall_alpha=0.05_tier=half_century_heavy_N=50000` | 0.86 | 0.9887 | 1.68 | 0.06 | 3579 |
| `shape=flat_baseline_alpha=0.70_tier=reign_heavy_N=50000` | 0.86 | nan | 10.64 | 0.22 | 33 |
...
| `shape=flat_baseline_alpha=0.50_tier=pilot_proxy_N=10000` | 0.87 | nan | 6.89 | 0.46 | 1 |
...
| `shape=smooth_growth_alpha=0.05_tier=pilot_proxy_N=10000` | 0.89 | 0.9024 | 4.24 | 0.20 | 103 |
| `shape=smooth_growth_alpha=0.30_tier=reign_heavy_N=50000` | 0.89 | 0.9344 | 7.16 | 0.16 | 5 |
| `shape=smooth_decline_alpha=0.30_tier=reign_heavy_N=50000` | 0.89 | 0.9378 | 3.78 | 0.17 | 8 |
| `shape=smooth_decline_alpha=0.05_tier=reign_heavy_N=10000` | 0.90 | 0.9005 | 3.96 | 0.30 | 1 |
| `shape=smooth_growth_alpha=0.05_tier=century_heavy_N=10000` | 0.91 | 0.8998 | 3.73 | 0.17 | 195 |
| `shape=smooth_decline_alpha=0.05_tier=pilot_proxy_N=10000` | 0.91 | 0.9116 | 4.26 | 0.30 | 17 |
| `shape=smooth_growth_alpha=0.05_tier=reign_heavy_N=10000` | 0.92 | 0.9045 | 3.66 | 0.24 | 1402 |
| `shape=smooth_decline_alpha=0.05_tier=uniform_N=10000` | 0.92 | 0.9063 | 4.41 | 0.28 | 28 |
| `shape=smooth_decline_alpha=0.05_tier=uniform_N=2000` | 0.93 | 0.7445 | 6.14 | 0.33 | 0 |
| `shape=smooth_growth_alpha=0.05_tier=half_century_heavy_N=10000` | 0.93 | 0.9000 | 4.09 | 0.23 | 76 |
| `shape=smooth_decline_alpha=0.05_tier=half_century_heavy_N=10000` | 0.93 | 0.9006 | 3.78 | 0.27 | 15 |
| `shape=flat_baseline_alpha=0.70_tier=uniform_N=50000` | 0.93 | nan | 8.39 | 0.34 | 0 |
| `shape=smooth_decline_alpha=0.05_tier=century_heavy_N=10000` | 0.95 | 0.9065 | 3.63 | 0.22 | 11 |
