...
# Per-grid base seeds. Decision-38 revalidation copy: the inscription base seed
# is 20_260_606 (matches design.json#base_seed for this re-validation), distinct
# from the lodged 2026-05-26 grid's 20_260_526 so the synthetic streams are fresh.
BASE_SEED_INSCRIPTION = 20_260_606
